...
namespace Toolkit.WinForm
{
    public partial class MDIMain : Form
    {
        ...
        private void 打开当前位置ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            var formSID = nameof(FormProjectList);
            if (openedForms.ContainsKey(formSID))
            {
                openedForms[formSID].Close();
            }

            openedForms[formSID] = new FormProjectList();
            openedForms[formSID].MdiParent = this;
